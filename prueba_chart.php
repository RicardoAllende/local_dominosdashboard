        ...
        <div class="col-lg-3">
            <div id="contenedor_filtros" align="left">
                ...
                <div class="card">
                    ...
                    <div id="collapse_0" class="collapse" aria-labelledby="indicatorheading0"
                        data-parent="#contenedor_filtros">
                        <div class="card-body subgrupo-filtro">
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'></span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Centro
                                Norte</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>PUEBLA-VERACRUZ</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>BAJIO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Barranca del
                                muerto</span><br>
                ...
                <div class="card">
                    ...
                    <div id="collapse_1" class="collapse" aria-labelledby="indicatorheading1"
                        data-parent="#contenedor_filtros">
                        <div class="card-body subgrupo-filtro">
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse_2" class="collapse" aria-labelledby="indicatorheading2"
                        data-parent="#contenedor_filtros">
                        <div class="card-body subgrupo-filtro">
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div id="collapse_3" class="collapse" aria-labelledby="indicatorheading3"
                        data-parent="#contenedor_filtros">
                        <div class="card-body subgrupo-filtro">
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'></span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VISTA HERMOSA
                                CUERNAVACA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CAFETALES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GUADALUPE
                                INN</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VISTA
                                HERMOSA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>DIVISION DEL
                                NORTE</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN
                                JERONIMO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TOLUCA
                                PILARES</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>OLIVAR DE LOS
                                PADRES</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>CHILPANCINGO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TOLUCA
                                INDEPENDENCIA</span><br>

                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>POPOCATEPETL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CONTRERAS</span><br>

                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>OBSERVATORIO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CARREFOUR
                                CUERNAVACA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TEMIXCO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PROGRESO
                                (CIMA)</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LERMA</span><br>

                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>RENACIMIENTO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>INTERLOMAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ALFONSO
                                XIII</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ACAPULCO CENTRO
                                CONSTITUYENTES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA
                                DIAMANTE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AEROPUERTO
                                TOLUCA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TECNOLOGICO
                                METEPEC</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN ANDRES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CUERNAVACA
                                CENTRO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AZTECAS SUR</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>JESUS DEL
                                MONTE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TORRE
                                DIAMANTE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ACAPULCO COSTA
                                AZUL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>WALMART
                                PLATEROS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MEGA
                                CUAUTLA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>IZTAPALAPA
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>JOSE MARIA
                                CASTORENA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>WM FELIX
                                CUEVAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PUEBLO SANTA
                                FE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PATIO
                                ACAPULCO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA
                                TENARIA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA LAS
                                PALMAS</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LOMAS DE
                                CUERNAVACA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA
                                EXHIBIMEX</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FUENTES DEL
                                PEDREGAL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AVENIDA
                                UNIVERSIDAD</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>RESIDENCIAL
                                VICTORIA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PASEOS DEL SOL MARIANO
                                OTERO</span><br>

                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>CIRCUNVALACION</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AJIJIC (PLAZA LA
                                FLORESTA)</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PIPILA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>EL PITILLAL
                                (VALLARTA)</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LIBRAMIENTO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AVILA
                                CAMACHO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>COLON</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>NUEVO
                                VALLARTA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CIUDAD
                                GUZMAN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GOBERNADOR
                                CURIEL</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FRANCISCO
                                VILLA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA
                                INDEPENDENCIA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ACUEDUCTO PUERTA DE
                                HIERRO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TEPIC SHOPPING
                                CENTER</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ZAPOPAN REAL
                                CENTER</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TESISTAN PLAZA LOS
                                ROBLES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ESPACIO
                                TLAQUEPAQUE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MACROPLAZA
                                ESTADIO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PALOMAR II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AV
                                GUADALUPE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA AGORA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VILLA DE
                                ALVAREZ</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TLAQUEPAQUE CENTRO
                                SUR</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>REVOLUCION
                                TIJUANA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SIMON
                                BOLIVAR</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VALLE
                                PONIENTE</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>OCAMPO
                                CENTRO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CHAPULTEPEC HEB
                                CHAPULTEPEC</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SANTO
                                DOMINGO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SANTA MARIA SORIANA
                                SANTA MARIA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LAS QUINTAS SORIANA
                                LAS QUINTAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SORIANA COSS
                                SALTILLO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GIGANTE
                                LINCOLN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>APODACA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SANTA
                                CATARINA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SALTILLO
                                FUNDADORES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SOLIDARIDAD</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN JERONIMO
                                MTY</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CARRETERA
                                NACIONAL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CHURUBUSCO
                                MTY</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SOLIDARIDAD
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GARZA SADA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MIRASIERRA
                                SALTILLO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VALLE
                                SOLEADO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PASEO DE
                                CUMBRES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MITRAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SENDERO
                                APODACA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA BELLA
                                HUINALA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>COBA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>QUETZAL PLAZA
                                QUETZAL</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CIUDAD DEL
                                CARMEN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CENTRO 2
                                PORTILLO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA
                                ESMERALDA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAYA DEL
                                CARMEN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FIESTA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>COZUMEL PLAZA
                                CARIBE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>DEL RIO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN FRANCISCO CIUDAD
                                DEL CARMEN 2</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VALLADOLID</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CAMPO
                                MILITAR</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ITZAES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FRANCISCO DE
                                MONTEJO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CHEDRAUI
                                CANCUN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LA LUNA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CD DEL CARMEN
                                III</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CHETUMAL
                                III</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MERIDA
                                ORIENTE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA LAS AMERICAS
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAYA DEL CARMEN
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MERIDA SUR</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FELIPE CARRILLO
                                PUERTO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VILLAGE
                                KABAH</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PARAISO
                                MAYA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAYA LAS
                                AMERICAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CD. DEL CARMEN
                                IV</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CITY CENTER
                                MERIDA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VILLAS DEL
                                MAR</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CAN CUN 2000 PLAZA
                                CANCUN 2000</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PUERTO
                                CANCUN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PUBLIC
                                MARKET</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>JUAN PABLO
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LAS
                                AMERICAS</span><br>

                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>TECAMACHALCO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SANTA CRUZ DEL
                                MONTE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GUSTAVO BAZ</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LOMAS
                                VERDES</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MELCHOR
                                OCAMPO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TLATELOLCO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>JARDIN
                                BALBUENA</span><br>

                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>AZCAPOTZALCO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>TLALNEPANTLA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>EDUARDO
                                MOLINA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LAGO DE
                                GUADALUPE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CUAUTITLAN
                                II</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ZONA
                                ESMERALDA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>W.M.ROJO
                                GOMEZ</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PRADO
                                VALLEJO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VILLA NICOLAS
                                ROMERO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA SAN
                                MARCOS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GRANJAS
                                GUADALUPE</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MULTIPLAZA ARAGON
                                II</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PARQUES
                                POLANCO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CERVANTES
                                SAAVEDRA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TACUBA
                                CENTRO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA AEROPUERTO
                                (TIENDA EXPRES)</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MULTIPLAZA
                                ALAMEDAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SANTA MARIA LA
                                RIBERA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GALERIAS
                                ATIZAPAN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA
                                CUAUHTEMOC</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GRAND PLAZA
                                ECATEPEC</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN MIGUEL
                                IZCALLI</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>RUIZ
                                CORTINES</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>NEZAHUALCOYOTL</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>EL COYOL
                                VERACRUZ</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN MARTIN
                                TEXMELUCAN</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>BOCA DEL
                                RIO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PANTITLAN
                                IV</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MARTINEZ DE LA
                                TORRE</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>POZA RICA
                                II</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>NEZAHUALCOYOTL
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PUEBLA
                                ANGELOPOLIS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN
                                SEBASTIAN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>IXTAPALUCA
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PARQUE
                                INDUSTRIAL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CHOLULA 2</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TEPEJI DEL
                                RIO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FORTIN DE LAS
                                FLORES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>VIA SAN
                                JUAN</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>TLAXCALA
                                CENTRO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SORIANA
                                CHAPULTEPEC</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA CIUDAD
                                CENTRAL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>XALAPA 3</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CRUZ DEL
                                SUR</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA CENTRO
                                SUR</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>MUNDO
                                FUTBOL</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>BORDO DE
                                XOCHIACA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>16 DE
                                SEPTIEMBRE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>BLVD. 5 DE
                                MAYO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CENTRAL DE
                                ABASTOS</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro"
                                style='color: black;'>CONSTITUYENTES</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>QUERETARO
                                II</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN JUAN DEL
                                RIO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>SAN MIGUEL DE
                                ALLENDE</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AGUASCALIENTES
                                INEGI</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GUADALUPE
                                ZACATECAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LEON 4
                                ARBIDE</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>BERNARDO
                                QUINTANA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>FRAY
                                JUNIPERO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>UBIKA
                                UNIVERSIDAD</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>DETECCION DE
                                TALENTO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>WAL-MART
                                TLAHUAC</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CENTRO COMERCIAL SANTA
                                FE</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PASEO
                                ACOXPA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GALERIAS
                                TOLUCA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PORTAL SAN
                                ANGEL</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GUADALAJARA
                                CENTRO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>METRO
                                TAXQUENA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>METRO PINO
                                SUAREZ</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>METRO LA
                                RAZA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ESTADIO AZTECA
                                EXPRESS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>INDIOS
                                VERDES</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>METRO 4
                                CAMINOS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>METRO
                                BALDERAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>CENTRO COMERCIAL EL
                                ROSARIO</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PARQUE VIA
                                VALLEJO</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>AMERICAS
                                XALAPA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ZOCALO
                                PUEBLA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GALERIAS HERMANO
                                SERDAN</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PARQUE
                                PUEBLA</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LEON CENTRO
                                MAX</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>ALTARIA
                                AGUASCALIENTES</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>GALERIAS
                                ZACATECAS</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>LA GRAN
                                PLAZA</span><br>
                            ...
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>PLAZA LA
                                CUSPIDE</span><br>
                ...
                <div class="card">
                    ...
                    <div id="collapse_4" class="collapse" aria-labelledby="indicatorheading4"
                        data-parent="#contenedor_filtros">
                        <div class="card-body subgrupo-filtro">
                            <input type="checkbox"> <span class="subfiltro" style='color: black;'></span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Coordinador de
                                entrenamiento</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Gerente de
                                Entrenamiento</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Especialista en
                                Reparto Seguro</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Jefe de
                                E.R.S.</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Gerente de
                                Tienda</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Preparador de Pizzas
                                Perfectas</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Preparador de Pizzas
                                Perfectas JR32</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Jefe de PPP</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Representante de
                                Servicio al Cliente</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Representante de
                                Servicio al Cliente J24</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Representante de
                                Servicio al Cliente J32</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Subgerente de
                                Tienda</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Supervisor de
                                Turno</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Ers</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Asistente
                                regional</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Director de
                                mercadotecnia</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Director regional
                                operaciones</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Coordinador de
                                mercadotecnia</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Gerente de distrito
                                (supervisor)</span><br>

                            <input type="checkbox"> <span class="subfiltro" style='color: black;'>Gerente sr. De
                                mercadotecnia</span><br>
